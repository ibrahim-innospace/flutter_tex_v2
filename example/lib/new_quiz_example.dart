...
class TeXViewQuizv2Example extends StatefulWidget {
  const TeXViewQuizv2Example({super.key});

  @override
  State<TeXViewQuizv2Example> createState() => _TeXViewQuizv2ExampleState();
}

class _TeXViewQuizv2ExampleState extends State<TeXViewQuizv2Example> {
