...
class _TeXViewQuizExampleState extends State<TeXViewQuizExample> {
  ...
  void initState() {
    ...
    quizList = [
      ...
      // ... (add your other quiz items here)
    ];

    if (quizList.isNotEmpty) {
      selectedOptionId = quizList[currentQuizIndex].options[0].id;
    }
  }

  void _updateSelectedOption(String id) {
    setState(() {
      selectedOptionId = id;
      isWrong = false;
    });
                ...
                onPressed: () {
                  setState(() {
                    if (currentQuizIndex > 0) {
                      currentQuizIndex--;
                      selectedOptionId =
                          quizList[currentQuizIndex].options[0].id;
                    }
                  });
                },
