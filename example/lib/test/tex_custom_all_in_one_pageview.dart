...
import 'package:flutter_tex_example/test/question_model.dart';
...
class _TeXViewQuizCustomExampleState extends State<TeXViewQuizCustomExample> {
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            if (snapshot.hasError) {
              ...
              return Center(
                ...
                //     return questionViewKatex(index);
                //   },
                // )
  ...
  TeXView questionViewKatex(int i) {
    return TeXView(
      fonts: const [
        TeXViewFont(fontFamily: 'army', src: 'fonts/Army.ttf'),
        TeXViewFont(
      ...
      child: TeXViewColumn(children: [
        // Question Title
        TeXViewDocument(
          quizList[i].questionText as String,
          style: TeXViewStyle(
              fontStyle: TeXViewFontStyle(
                sizeUnit: TeXViewSizeUnit.pt,
              ),
        ...
        // Group of TeXViewDocument
        TeXViewGroup(
            children: quizList[i].options!.map((Option option) {
              return TeXViewGroupItem(
                rippleEffect: false,
                id: "2",
                child: TeXViewDocument(
